...
export default function MMSE() {
  ...
  const [audioFiles] = useState({
    mmseIntroduction: new Audio('/mmse_introduction.mp3'),
    mmseQuestion: new Audio('/mmse_question.mp3'),
    mmseComplete: new Audio('/mmse_complete.mp3')
  });
  ...
  // 각 상황별 재생 함수들
  const playMMSEIntroduction = () => playAudio(audioFiles.mmseIntroduction);
  const playMMSEQuestion = () => playAudio(audioFiles.mmseQuestion);
  const playMMSEComplete = () => playAudio(audioFiles.mmseComplete);
