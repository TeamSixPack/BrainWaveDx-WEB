...
export default function TestModeSelection() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] via-[#dbeafe] to-[#f1f5f9] p-4">
      {/* Header */}
      <header className="border-b bg-background/80 backdrop-blur-sm mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-xl text-blue-600">음성안내 모드</CardTitle>
          ...
          >
            <CardHeader className="text-center pb-4">
              <div className="flex justify-center mb-4">
                                 <div className="p-3 bg-blue-100 rounded-full">
                   <VolumeX className="h-8 w-8 text-blue-600" />
                 </div>
              </div>
                             <CardTitle className="text-xl text-blue-600">일반 모드</CardTitle>
              <CardDescription className="text-base">
